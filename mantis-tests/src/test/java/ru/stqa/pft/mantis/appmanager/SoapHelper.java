...
public class SoapHelper {
    ...
    public Set<Project> getProjects() throws MalformedURLException, ServiceException, RemoteException {
        ...
        ProjectData[] projects = mc.mc_projects_get_user_accessible(app.getProperty("web.adminLogin"), app.getProperty("web.adminPassword")); //список доступных для пользователя проектов
